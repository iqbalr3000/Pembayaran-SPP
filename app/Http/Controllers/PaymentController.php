...
class PaymentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->jumlah_bayar < $spp->nominal){
            return redirect('/pembayaran/create')->with('success', 'Uang anda kurang');
        }
        ...
        return redirect('/pembayaran')->with('success', 'pembayaran berhasil, kembalian anda Rp.'.$kembalian);
    }
