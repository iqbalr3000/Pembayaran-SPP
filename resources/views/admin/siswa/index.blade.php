...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <a href="{{url('/siswa/create')}}" class="btn btn-block btn-primary">Buat</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <table class="table" id="tableSiswa">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{url('/siswa/delete/'.$a->kode)}}" method="POST">
                                        @csrf
                                        @method('DELETE')

                                        <a href="{{url('/siswa/edit/'.$a->kode)}}" class="btn btn-warning">Edit</a>
